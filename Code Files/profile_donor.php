                ...
                <div class='card-body'>
                    <div class='card-title mb-4'>
                        <div class='d-flex justify-content-start'>
                            ...
                            @$var =$_SESSION['email'];
							@$result = mysqli_query($connect,"SELECT `profile` FROM `donor_reg` WHERE `donor_reg`.`email`='$var'");
							@$numrows = mysqli_num_rows($result);
							if(@$numrows != 0)
							{
								while(@$row = mysqli_fetch_assoc(@$result))
								{
									echo '<img src="uploaded_profile_donor/'.$row['profile'].'" id="imgProfile" style="width: 150px; height: 150px" class="img-thumbnail"/>';
								}
							}                             
                                echo "
                                <!--<div class='middle'>
                            ...
                            <div class='userData ml-3'>
                                <h2 class='d-block' style='font-size: 1.5rem; font-weight: bold'><a
                                        href='javascript:void(0);'><br><br>"; echo ' '.$_SESSION['Fname'].' '.$_SESSION['Lname']; 
                                        echo "</a></h2>
                            ...
                            <ul class='nav nav-tabs mb-4' id='myTab' role='tablist'>
                                ...
                                <li class='nav-item'>
                                    <a class='nav-link' id='connectedServices-tab' data-toggle='tab'
                                        href='Donor_dashboard.php' role='tab' aria-controls='connectedServices'
